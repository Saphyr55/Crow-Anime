CREATE TABLE anime(
  id_anime INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL,
...
CREATE TABLE manga(
  id_manga INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE _character(
  id_character INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT ,
  name_character VARCHAR(250)
);
CREATE TABLE episode(
  id_episode INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT,
  episode_date DATE,
...
CREATE TABLE news(
    id_news INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT,
    news_text      TEXT,
    news_date      DATETIME,
    news_url_video VARCHAR(255)
);
INSERT INTO news VALUES(1,'An anime adaptation of Arknights, titled Arknights: Prelude to Dawn, is currently in production by Yostar Pictures and was announced in October 24, 2021. The anime will adapt the Main Theme, thus making it canon to the Arknights storyline.','2022-04-25','https://www.youtube-nocookie.com/embed/NakocJ9Ky0I?controls=0?rel=0');
INSERT INTO news VALUES(2,'General of the Three Kingdoms, Kongming had struggled his whole life, facing countless battles that made him into the accomplished strategist he was. So on his deathbed, he wished only to be reborn into a peaceful world... and was sent straight to modern-day party-central, Tokyo! Can even a brilliant strategist like Kongming adapt to the wild beats and even wilder party people?!\,','2022-04-25','https://www.youtube.com/embed/FN4pZixlYPc');
...
CREATE TABLE volumes(
  id_volume INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT,
  volume_date DATE,
