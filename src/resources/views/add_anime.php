            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="year-season">
                    ...
                    <select name="season_anime" id="">
                        <option value="<?= CrowAnime\Work\Season::SPRING ?>">Spring</option>
                        <option value="<?= CrowAnime\Work\Season::SUMMER ?>">Summer</option>
                        <option value="<?= CrowAnime\Work\Season::FALL ?>">Fall</option>
                        <option value="<?= CrowAnime\Work\Season::WINTER ?>">Winter</option>
                    </select>
                </div>
                <br>
                <div>
